...
def get_dec_axes(data_tr, wc, bc, we, be, false_files,pop_correct, pop_zero, pop_error, USE_POP, mode='decoding',
    ...
    Xmerge_hist_trials_correct, ymerge_hist_labels_correct,\
        ...
        gpt.merge_pseudo_hist_trials_individual(Xdata_hist_set, ylabels_hist_set,
    ...
    # Xmerge_hist_trials_correct, ymerge_hist_labels_correct,\
    # Xmerge_hist_trials_error, ymerge_hist_labels_error, _ =\
    # gpt.merge_pseudo_hist_trials_individual(Xdata_set, ylabels_set,
    #                              unique_states, unique_cohs, files,
    #                              false_files, 2,  RECORD_TRIALS=1,
    #                              RECORDED_TRIALS=[])
    ...
    mmodel, coeffs, intercepts, Xtest_shuffle_correct, ytest_shuffle_correct,\
        ...
        = bl.shuffle_linsvm_proj_step(coeffs, intercepts, Xdata_hist_set, NN,
                                      ylabels_hist_set, unique_states,
                                      unique_cohs, files, false_files, pop_correct, pop_zero,pop_error, USE_POP, type,
                                      DOREVERSE=DOREVERSE, CONTROL=CONTROL,
                                      n_iterations=NITERATIONS,
                                      N_pseudo_dec=NPSEUDODEC,
                                      train_percent=PERCENTTRAIN,
                                      RECORD_TRIALS=RECORD_TRIALS,
...
if __name__ == '__main__':
    ...
    # 'files_pop_analysis/'
    rats =  ['Rat7'] #['Patxi',  'Rat31', 'Rat15', 'Rat7',15
    for r in rats:
        # plt.close('all')
        ...
        if STIM_PERIOD==1:
            ...
            CONTROL=2
            # data_int_ac,Xbeh_test_correct, Xbeh_test_error = hist_integration(data_tr,[], [], [], [], false_files, mode='decoding',DOREVERSE=0,CONTROL=CONTROL, STIM_PERIOD=STIM_PERIOD, RECORD_TRIALS=1, REC_TRIALS_SET=np.zeros(NITERATIONS),PCA_only=PCA_only, mmodel=mmodel)
