...
'''
def req_quantities_congruent7(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(iiist,len(stim_trials)):
        ...
        if(prev2_stats['rw']==1 and prev3_stats['rw']==1 and \
            prev4_stats['rw']==1 and prev5_stats['rw']==1 and \
                prev6_stats['rw']==1 and prev7_stats['rw']==1 and prev8_stats['rw']==1):
            ### case 1
            if(prev8_stats['choice']==-1 and prev7_stats['choice']==-1 and prev6_stats['choice']==-1 \
                and prev5_stats['choice']==-1 and prev4_stats['choice']==-1 and prev3_stats['choice']==-1 \
                ...
                # print('decision:',curr_stats['start_end'][1]-1,' stim:',curr_stats['start_end'][0])
                ...
                if(prev1_stats['gt']==-1):
                    ...
                    Xgts_1.append(1)
            ### case 2
            elif(prev8_stats['choice']==1 and prev7_stats['choice']==1 and prev6_stats['choice']==1 \
                and prev5_stats['choice']==1 and prev4_stats['choice']==1 and prev3_stats['choice']==1 \
                    and prev2_stats['choice']==1 and prev1_stats['choice']==1):
                if (curr_stats['gt']==1 and prev1_stats['rw']==0):
                    continue
                ...
                # print('decision:',curr_stats['start_end'][1]-1,' stim:',curr_stats['start_end'][0])
                nact = np.shape(curr_stats['resp'])[0]
                Xconds_2 = np.append(Xconds_2,0*np.ones(nact),axis=0) ### RRR#1*np.ones(nact),axis=0) ### RRR
                if(prev1_stats['choice']==-1):
                    # print(curr_stats['start_end'][0]-1)
                    Xlfs_1  = np.append(Xlfs_1,0*np.ones(nact))
                    Xacts_1 = np.append(Xacts_1,0*np.ones(nact)) ### REP+L ---> LEFT BIAS
            ...
            ### case 4
                ...
                nact = np.shape(curr_stats['resp'])[0]
                Xconds_2 = np.append(Xconds_2,1*np.ones(nact),axis=0) ### RLR3*np.ones(nact),axis=0) ### RLR
                if(prev1_stats['choice']==-1):
                    Xlfs_1  = np.append(Xlfs_1,0*np.ones(nact))
                    Xacts_1 = np.append(Xacts_1,1*np.ones(nact))
                    # print(curr_stats['start_end'][0]-1)
    ...
    rses,Xacts_0,Xrws_0,Xgts_0,Xgts_1,Xcohs_0,Xdc_idx_0
def req_quantities_congruent3(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(5,len(stim_trials)):
        ...
        if(prev2_stats['rw']==1 and prev3_stats['rw']==1 and prev4_stats['rw']==1 and prev5_stats['rw']==0):###prev1_stats['rw']==1 and
            ### case 1
            if(prev4_stats['choice']==-1 and prev3_stats['choice']==-1 and prev2_stats['choice']==-1 and prev1_stats['choice']==-1):
                if (curr_stats['gt']== -1 and prev1_stats['rw']==0):
                    continue
                if (curr_stats['gt']== 1 and prev1_stats['rw']==1):
                    continue
                ...
                if(prev1_stats['gt']==-1):
                    ...
                    Xgts_1.append(1)
            ### case 2
            elif(prev4_stats['choice']==1 and prev3_stats['choice']==1 and prev2_stats['choice']==1 and prev1_stats['choice']==1):
                if (curr_stats['gt']==1 and prev1_stats['rw']==0):
                    continue
                if (curr_stats['gt']==-1 and prev1_stats['rw']==1):
                    continue
    ...
    return Xdata,ydata,Xdata_idx,Xdata_resp,Xconds_2,Xacts_1,Xrws_1,Xlfs_1,Xrse_6,\
    rses,Xacts_0,Xrws_0,Xgts_0,Xgts_1,Xcohs_0,Xdc_idx_0
def req_quantities_0(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc, BLOCK_CTXT=0):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(iiist,len(stim_trials)):
        ...
        if(prev2_stats['choice']==-1 and prev1_stats['choice']==-1):
            ...
            if (BLOCK_CTXT):
                # 'ctx'
                Xconds_2 = np.append(Xconds_2,curr_stats['ctx']*np.ones(nact),axis=0)
            else:
                Xconds_2 = np.append(Xconds_2,0*np.ones(nact),axis=0) ### LLL
            if(prev1_stats['choice']==-1):
                Xlfs_1  = np.append(Xlfs_1,0*np.ones(nact))
        ...
        ### case 4
            ...
            if(prev1_stats['gt']==-1):
                ...
                Xgts_1.append(1)
    return Xdata,ydata,Xdata_idx,Xdata_resp,Xconds_2,Xacts_1,Xrws_1,Xlfs_1,Xrse_6,\
    rses,Xacts_0,Xrws_0,Xgts_0,Xgts_1,Xcohs_0,Xdc_idx_0,Xdata_trialidx
def req_quantities_1(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
...
def req_quantities_4(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(iiist,len(stim_trials)):
        ...
        if(prev2_stats['rw']==1 and prev3_stats['rw']==1 and prev4_stats['rw']==1 and prev5_stats['rw']==1 and prev6_stats['rw']==0):
            ### case 1
            if(prev5_stats['choice']==-1 and prev4_stats['choice']==-1 and prev3_stats['choice']==-1 \
                and prev2_stats['choice']==-1 and prev1_stats['choice']==-1):
                Xdc_idx_0 = np.append(Xdc_idx_0,curr_stats['start_end'][1]-1)
                Xdata_idx = np.append(Xdata_idx,curr_stats['start_end'][0]-1)
                # print('decision:',curr_stats['start_end'][1]-1,' stim:',curr_stats['start_end'][0])
                ...
                if(prev1_stats['gt']==-1):
                    ...
                    Xgts_1.append(1)
            ### case 2
            elif(prev5_stats['choice']==1 and prev4_stats['choice']==1 and prev3_stats['choice']==1 \
                and prev2_stats['choice']==1 and prev1_stats['choice']==1):
                Xdata_idx = np.append(Xdata_idx,curr_stats['start_end'][0]-1)
                Xdc_idx_0 = np.append(Xdc_idx_0,curr_stats['start_end'][1]-1)
                # print('decision:',curr_stats['start_end'][1]-1,' stim:',curr_stats['start_end'][0])
...
def req_quantities_3(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(iiist,len(stim_trials)):
        ...
        if(prev2_stats['rw']==1 and prev3_stats['rw']==1 and prev4_stats['rw']==1 and prev5_stats['rw']==0):
            ### case 1
    ...
    return Xdata,ydata,Xdata_idx,Xdata_resp,Xconds_2,Xacts_1,Xrws_1,Xlfs_1,Xrse_6,\
    rses,Xacts_0,Xrws_0,Xgts_0,Xgts_1,Xcohs_0,Xdc_idx_0
def req_quantities_3all(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc,BLOCK_CTXT=0):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(iiist,len(stim_trials)):
        ...
        if(prev2_stats['rw']==1 and prev3_stats['rw']==1 and prev4_stats['rw']==1):
            ### case 1
            if(prev4_stats['choice']==-1 and prev3_stats['choice']==-1 \
                and prev2_stats['choice']==-1 and prev1_stats['choice']==-1):
                Xdc_idx_0 = np.append(Xdc_idx_0,curr_stats['start_end'][1]-1)
...
def req_quantities_2(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(iiist,len(stim_trials)):
        ...
        if(prev2_stats['rw']==1 and prev3_stats['rw']==1 and prev4_stats['rw']==0):
            ### case 1
            if(prev3_stats['choice']==-1 and prev2_stats['choice']==-1 and prev1_stats['choice']==-1):
                ...
                if(prev1_stats['gt']==-1):
                    ...
                    Xgts_1.append(1)
            ### case 2
            elif(prev3_stats['choice']==1 and prev2_stats['choice']==1 and prev1_stats['choice']==1):
                #### @YX 1909 note this is only the fixation
                Xdata_idx = np.append(Xdata_idx,curr_stats['start_end'][0]-1)
                Xdc_idx_0 = np.append(Xdc_idx_0,curr_stats['start_end'][1]-1)
                # print('decision:',curr_stats['start_end'][1]-1,' stim:',curr_stats['start_end'][0])
    ...
    return Xdata,ydata,Xdata_idx,Xdata_resp,Xconds_2,Xacts_1,Xrws_1,Xlfs_1,Xrse_6,\
    rses,Xacts_0,Xrws_0,Xgts_0,Xgts_1,Xcohs_0,Xdc_idx_0
def req_quantities_5(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(iiist,len(stim_trials)):
        ...
        if(prev2_stats['rw']==1 and prev3_stats['rw']==1 and \
            ...
            ### case 1
            if(prev6_stats['choice']==-1 and prev5_stats['choice']==-1 and prev4_stats['choice']==-1 and prev3_stats['choice']==-1 and prev2_stats['choice']==-1 and prev1_stats['choice']==-1):
                ...
                if(prev1_stats['gt']==-1):
                    ...
                    Xgts_1.append(1)
            ### case 2
            elif(prev6_stats['choice']==1 and prev5_stats['choice']==1 and prev4_stats['choice']==1 and prev3_stats['choice']==1 and prev2_stats['choice']==1 and prev1_stats['choice']==1):
...
def req_quantities_6(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
    ...
    for i in range(iiist,len(stim_trials)):
        ...
        if(prev2_stats['rw']==1 and prev3_stats['rw']==1 and \
            prev4_stats['rw']==1 and prev5_stats['rw']==1 and \
                prev6_stats['rw']==1 and prev7_stats['rw']==1 and prev8_stats['rw']==0):
            ### case 1
            if(prev7_stats['choice']==-1 and prev6_stats['choice']==-1 and prev5_stats['choice']==-1 and prev4_stats['choice']==-1 and prev3_stats['choice']==-1 and prev2_stats['choice']==-1 and prev1_stats['choice']==-1):
                ...
                if(prev1_stats['gt']==-1):
                    ...
                    Xgts_1.append(1)
            ### case 2
            elif(prev7_stats['choice']==1 and prev6_stats['choice']==1 and prev5_stats['choice']==1 and prev4_stats['choice']==1 and prev3_stats['choice']==1 and prev2_stats['choice']==1 and prev1_stats['choice']==1):
...
def req_quantities_7(stim_trials,cohvalues,stm,dyns,gt,choice,eff_choice,rw,obsc):
    #### ---- prepare LDA data
    Xdata,ydata = [],[]
    Xdata_idx = []
    Xdc_idx_0 = []
...
def sep_correct_error(stm,dyns,Xdata,ydata,Xdata_idx,Xdata_resp,Xconds_2,Xacts_1,Xrws_1,Xlfs_1,\
    Xrse_6,rses,Xacts_0,Xrws_0,Xgts_0,Xgts_1,Xcohs_0,Xdc_idx_0,Xdata_trialidx,\
    margin=[1,2],idd=1):
    # margin=[1,2]
    ...
    # correct_trial,error_trial= np.where(ydata_bias>=2)[0],np.where(ydata_bias<2)[0]
    ...
    return Xdata_correct,correct_trial,Xdata_stim_correct,Xdata_dc_correct,\
        ych_stim_correct,Xdata_correct_seq,Xdata_error,error_trial,Xdata_stim_error,\
            Xdata_dc_error,ych_stim_error,Xdata_error_seq,\
                rses_correct,rses_error,Xrse_6_correct,Xrse_6_error,Xcohs_0_correct,\
                    Xcohs_0_error,ydata_bias_correct,ydata_bias_error,ydata_xor_correct,ydata_xor_error,\
                        ydata_conds_correct,ydata_conds_error,ydata_choices_correct,\
                            ydata_choices_error,ydata_cchoices_correct,ydata_cchoices_error,\
                                ydata_cgts_correct,ydata_cgts_error,ydata_crws_correct,ydata_crws_error,\
                                    Xdata_idx_correct,Xdata_idx_error,Xdata_trialidx_correct,Xdata_trialidx_error
